...
function HeroHome() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 pt-32 pointer-events-none" aria-hidden="true">
        ...
        <div className="pb-12">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="md:text-2xl text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Tok´n Show construye una nueva relación con los artistas, creadores de esos instantes únicos que queremos recordar, que dicen algo de nosotros y que nos gustaría tener. 
Gracias a nuevas tecnologías como Blockchain y contratos inteligentes nos permite comprar elementos únicos digitales.
El futuro de la industria, hoy.</p>
